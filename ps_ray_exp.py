...
spec = importlib.util.spec_from_file_location("module.name", "/home/app/CheckFreq/distributed/config_model.py")
config_model = importlib.util.module_from_spec(spec)
spec.loader.exec_module(config_model)

spec1 = importlib.util.spec_from_file_location("module.name", "/home/app/CheckFreq/distributed/dist_chk.py")
dist_chk = importlib.util.module_from_spec(spec1)
spec1.loader.exec_module(dist_chk)

spec2 = importlib.util.spec_from_file_location("module.name", "/home/app/CheckFreq/distributed/vgg_torch.py")
vgg_torch = importlib.util.module_from_spec(spec2)
spec2.loader.exec_module(vgg_torch)
...
class PS(object):
    def __init__(self, idx, freq, num_ps, checkp_local, rocksdb_lat, model_name, synchronous):
        ...
        self.dirpath = '/home/app/CheckFreq/distributed/checkpoint/'
...
def main():
    ...
    local_hostname = '10.138.0.95'#ray.services.get_node_ip_address()
